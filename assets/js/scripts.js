...
if (navigation) {
    ...
    window.addEventListener('scroll', () => {
        ...
        if (scrollTop > lastScrollTop) {
            // Scrolling down
            if (scrollTop > 300) {
                navigation.classList.add("fixed-top", "bg-body-tertiary2", "border-bottom", "border-light", "border-opacity-10");
            ...
            if (scrollTop > 300) {
                ...
                navigation.classList.remove("fixed-top", "bg-body-tertiary2", "border-bottom", "border-light", "border-opacity-10");
